...
int main() {
  ...
  bool resultatLectureAuteurs =
      gestionnaireAuteurs.chargerDepuisFichier("auteurs.txt") && gestionnaireAuteurs.chargerDepuisFichier("auteurs.txt");
  bool resultatLectureFilms =
      librairie.chargerFilmsDepuisFichier("films.txt", gestionnaireAuteurs) && librairie.chargerFilmsDepuisFichier("films.txt", gestionnaireAuteurs);
  bool resultatLectureRestrictions =
      librairie.chargerRestrictionsDepuisFichiers("restrictionsPays.txt") && librairie.chargerRestrictionsDepuisFichiers("restrictionsPays.txt");
  ...
  for (unsigned int i = 0; i < test8NbFilmsAjouter/2; i++) {
	  (librairie += new Film("test", 1, Film::Genre::Action, Pays::Canada, false, &auteurTest8))
  ...
  stringRecu.erase(
	  std::remove_if(stringRecu.begin(), stringRecu.end(),
		  [](unsigned char c) { return std::isspace(c); }),
	  stringRecu.end());
  ...
  filmStream << Film("film2", 1990, Film::Genre::Aventure, Pays::France, true, &auteurTest65) << std::endl;
